...
# @@File             :  install.sh
# @@Description      :  Install configurations for volumeicon
...
GLOBAL_OS_PACKAGES="volumeicon notify-send "
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Run custom actions
__app_is_running volumeicon && VOLUMEICON_IS_RUNNING="true"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__run_post_install() {
  local getRunStatus=0
  [ "$VOLUMEICON_IS_RUNNING" = "true" ] && __silent_start volumeicon
  return $getRunStatus
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
